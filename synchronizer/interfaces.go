...
type ethermanInterface interface {
	...
	GetPreconfirmationsByBlockRange(ctx context.Context, fromL2Block uint64, toL1Block *uint64, blocks *[]etherman.Block, order *map[common.Hash][]etherman.Order) error
}
